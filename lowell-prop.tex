...
%   Last update 2016-04-18 by hroe@lowell.edu
...
%%%
\begin{abstract}
Lorem ipsum dolor sit amet 10$\deg$F, consectetur adipiscing elit. Etiam vitae felis lectus. Nulla eu malesuada arcu. Aliquam arcu orci semper venenatis sed non purus. Pellentesque tempus nibh dolor. Donec eros lorem, gravida quis euismod, tempus amet neque. Maecenas tempus ex fermentum purus maximus porttitor. Class aptent taciti sociosqu ad litora per conubia nostra, per inceptos himenaeos. Sed nec metus suscipit metus ultricies fringilla. Pellentesque habitant morbi tristique senectus et netus malesuada fames ac turpis egestas. Praesent id viverra eros. Pellentesque tempus nibh dolor. Donec eros lorem, gravida quis euismod, tempus sit neque. Maecenas tempus fermentum maximus porttitor. 
\end{abstract}



% Indicate whether this proposal is part of PhD thesis work by
...
%%%
\thesis{}  % uncomment this line if this proposal is part of a PhD thesis.
...
%%%
\unusabledates{
January 24-26, attending conference  Donec euismod egestas ligula ut semper. Pellentesque ultricies metus sit amet laoreet dictum. Pellentesque efficitur leo id orci condimentum lacinia. Vestibulum egestas fermentum dictum. Vestibulum velit lorem, luctus nec sodales eget, rutrum id lorem. 
}
...
% The Science Justification section is limited to one page of text and
% up to one additional page of references and figures (which can be
% integrated into the text).  Write for a general scientific audience.
...
Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam vitae felis lectus. Nulla eu malesuada arcu. Aliquam a arcu in orci semper venenatis sed non purus. Pellentesque tempus nibh dolor. Donec eros lorem, gravida quis euismod eu, tempus sit amet neque. Maecenas tempus ex fermentum purus maximus porttitor. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Sed nec metus suscipit metus ultricies fringilla. 
...
% that follow the \techJustification line.
%
...
% How effectively have you used DCT in the past? 
% List your allocation of telescope time at DCT during the past 2 years,
...
% current proposal with a \relatedwork{} command.  
...
\item November 2015, 2 nights DCT, "Looking for liners in all the wrong places".  Never opened due to the sudden seagull infestation and concerns for primary mirror safety.

\item February 2016, 2 nights assigned DCT after current proposal deadline, "Still looking, this time in different wrong places".  
