...
%   Last update 2017-02-21 by hroe@lowell.edu
...
% 
% DCT is scheduled on calendar quarters:
%     Q1: January 1 - March 31
%     Q2: April 1 - June 30
%     Q3: July 1 - September 30
%     Q4: October 1 - December 31
% The deadline for Lowell proposals and for partner institutions to submit their
% ranked requests is noon MST on the 1st of the month (or next business day if 
% the 1st is a holiday or weekend) two months ahead of the start of the quarter.  
%     e.g. the deadline for 2017Q1 is 1-Nov-2016 Noon MST
% 
...
%         \instrument{LMI: UBVRI, H\textalpha-on,H\textalpha-off; NIHTS}
%   \numfirsthalfnights{} For example, \numfirsthalfnights{3}
%   \numsecondhalfnights{} For example, \numsecondhalfnights{3}
...
% Observing Request Details section.
%
...
% Observing Request Details.
%
% The style file will accomodate up to 10 separate observing runs, of which the 
% the first 3 will be shown on the primary cover page and the remainder will be
% shown on the overflow coverpage (if needed).
...
% Include any other scheduling comments, such as dates (local MST) you cannot use 
% for non-astronomical reasons. If a longer explanation is needed,  
% summarize the request here and provide more details in the Observing Request
...
% Don't edit or comment out the following 2 lines containing \EndOfPrimaryCoverPage{}
% and \OverflowFromCoverPage{}
...
% **Proposers from DCT partner institutions:** Check with your home institution
% regarding Science Justification page limits and any other requirements. Some 
% partner institutions do not require a Science Justification & others have established
% a longer limit than the default 1 page.
...
% If you are absolutely convinced you understand and are obeying the page limit of the 
% Observing Request Details section, you may uncomment the following flag, which will 
% remove the instructions for this section from the PDF and buy you a little more space.
% But, if you do that *and* break the page limit *or* forget to address any relevant 
% details because you didn't read the instructions, a pox will be cast upon you.
% And, if you break the page limit and leave the instructions in, then you're just not
% paying attention.
